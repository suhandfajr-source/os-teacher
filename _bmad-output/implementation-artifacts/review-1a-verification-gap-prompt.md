...
Review content: the unified diff below (inlined — this session has no filesystem access to the original; the repository described is a Next.js + Prisma 7 project whose test suite is `npm test` = vitest, 43 files / 475 tests, all green):
