# Review Task: Verification Gap — Story 7 (jalankan di session LLM terpisah)
...
Do not invoke any skill, and do not spawn subagents of your own — you are the reviewer. Return your findings as text in your final message per the instruction file's OUTPUT FORMAT. If the instruction file is unreadable, report that exact failure and stop.

=== INSTRUCTION FILE (verification-gap.md) ===
