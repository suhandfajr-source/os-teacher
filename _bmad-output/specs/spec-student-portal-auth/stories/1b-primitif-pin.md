...
- 2026-09-20 (walkthrough deep-dive patch): ditemukan vektor yang lolos aturan memori — CPU work `N·r·p` tak dibatasi (terukur linear: N=2048,p=2048 → 3,5s; titik ekstrem memory-legal `scrypt:262144:1:262143` ≈ 7 jam CPU per verify tanpa throw/OOM). Patch: bound total-kerja `SCRYPT_MAX_WORK = 2²²` (32× kerja default) di parse + param wajib desimal murni `/^\d+$/` (tutup `0x10`/`1e2`); regresi titik-ekstrem + sanity roundtrip. 45/45 test file PIN hijau, tsc+eslint bersih, full suite 520/520.
